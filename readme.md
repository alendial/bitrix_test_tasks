...
##
twr:catalog - одиночный компонент  
twr:complex_catalog - комплексный компонент работающий на twr:catalog_tree и twr:catalog_list  
смотреть можно здесь http://zebrains.twinrocket.ru
